...
#define TSK_ACTIVE_MM 1572 /* offsetof(struct task_struct, active_mm) */
#define TSK_STACK_CANARY 1664 /* offsetof(struct task_struct, stack_canary) */
...
#define TI_TP_VALUE 68 /* offsetof(struct thread_info, tp_value) */
#define TI_FPSTATE 80 /* offsetof(struct thread_info, fpstate) */
#define TI_VFPSTATE 224 /* offsetof(struct thread_info, vfpstate) */
#define VFP_CPU 272 /* offsetof(union vfp_state, hard.cpu) */
#define SOFTIRQ_DISABLE_OFFSET 512 /* SOFTIRQ_DISABLE_OFFSET */
...
#define SVC_TTBCR 76 /* offsetof(struct svc_pt_regs, ttbcr) */
...
#define MM_CONTEXT_ID 624 /* offsetof(struct mm_struct, context.id.counter) */
