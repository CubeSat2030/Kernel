...
Prerequisite: ``CONFIG_DYNAMIC_FTRACE`` & ``#include <ftrace.h>``
...
Prerequisite: ``CONFIG_DEBUG_FS` & `#include <debugfs.h>``
...
Prerequisite: ``CONFIG_DEV_COREDUMP`` & ``#include <devcoredump.h>``
